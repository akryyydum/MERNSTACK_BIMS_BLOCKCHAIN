...
A secure and decentralized **Barangay Management System** built with the **MERN stack** and **Hyperledger Fabric**, designed to manage resident data, document requests, and approvals with **transparency and immutability**.
...
**Goals:**  
- Reduce manual paperwork and streamline barangay processes.  
- Ensure **data integrity** and transparency using blockchain.  
- Provide an intuitive system for both residents and officials.  
...
- **Verification System:** Barangay officials can verify or reject residents.  
...
- **Blockchain Ledger:** All operations recorded on Hyperledger Fabric for auditability.  
